        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-gray-600 mb-10 max-w-2xl mx-auto lg:mx-0 leading-relaxed text-balance">
              Gestiona tu almacén, crea menús inteligentes y asegura la calidad de tus platos. Todo lo que necesitas para administrar un restaurante profesional en un solo lugar.
            </p>
